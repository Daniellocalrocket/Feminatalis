...
const IMAGE_CONFIG = [
  ...
  },
  {
    ...
    images: [
      ...
      { key: "img_mitochondrium_2", label: "Mitochondrien – Mitochondrium 2", page: "Mitochondrien", default: "/assets/Mitochondrium 2.jpg" },
      ...
      { key: "img_brainlight_system", label: "BrainLight – System", page: "BrainLight", default: "/assets/brainlight-system.jpg" },
