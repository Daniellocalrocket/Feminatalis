...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background font-sans">
      {/* Header */}
      <header
        className="fixed top-0 left-0 right-0 z-[100] bg-background border-b border-border shadow-sm h-20 flex items-center"
      >
        <div className="container mx-auto px-4 h-full flex items-center justify-between">
          ...
          {/* Mobile Menu Toggle */}
          <button
            className="xl:hidden p-2 text-foreground relative z-[110]"
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                <strong>Angela Deschner</strong> – Deine Praxis für funktionelle Medizin und Naturheilkunde & Hebammenpraxis in Bad Schönborn. 
